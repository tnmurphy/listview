...
inline void append_display_element(DisplayElement **list, DisplayElement *item) {
  DisplayElement *find;
...
int find_tokens(char *string, Token tokens[], int max_tokens) {
  ...
  /* search for the last non-whitespace character before a separator or before the end of the string */
  }
